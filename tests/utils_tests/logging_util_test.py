...
class LoggingUtilTestCase(unittest.TestCase):
    ...
    def test_json_formatter_for_message(self):
        ...
        self.assertIn('"level": ', stdout_str)
        self.assertIn('"message": ', stdout_str)
        self.assertNotIn('"details": ', stdout_str)
        self.assertNotIn('"exception": ', stdout_str)
        self.assertNotIn('"stack": ', stdout_str)


    def test_json_formatter_for_details(self):
        ...
        self.assertIn('"level": ', stdout_str)
        self.assertIn('"message": ', stdout_str)
        self.assertIn('"details": ', stdout_str)
        self.assertNotIn('"exception": ', stdout_str)
        self.assertNotIn('"stack": ', stdout_str)


    def test_json_formatter_for_exception(self):
        ...
        self.assertIn('"message": ', stdout_str)
        self.assertNotIn('"details": ', stdout_str)
        self.assertIn('"exception": ', stdout_str)
        self.assertNotIn('"stack": ', stdout_str)


    def test_json_formatter_for_exception_stack(self):
        ...
        self.assertNotIn('"details": ', stdout_str)
        self.assertIn('"exception": ', stdout_str)
        self.assertIn('"stack": ', stdout_str)


    def test_json_formatter_for_details_exception_stack(self):
